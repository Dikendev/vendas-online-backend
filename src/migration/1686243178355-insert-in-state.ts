...
export class InsertInState1686243178355 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    queryRunner.query(`
            ...
            INSERT INTO state("id", "name", "uf") VALUES (8, 'Espirito Santo', 'ES');
            ...
            INSERT INTO state("id", "name", "uf") VALUES (16, 'Pernanbuco', 'PE');
